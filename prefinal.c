...
{
    int ch;
    printf("time taken by Merge Sort: %f microseconds \n\n",mergeSort(arr,0,size-1));
    printf("time taken by Bubble Sort: %f microseconds \n\n",bubbleSort(arr,size));
    printf("time taken by Selection Sort: %f microseconds \n\n",selectionSort(arr,size));
    printf("time taken by Insertion Sort: %f microseconds \n\n",insertionSort(arr,size));
    printf("time taken by Radix Sort: %f  microseconds \n\n",radixsort(arr,size));
    printf("time taken by quick Sort: %f microseconds \n\n",quicksort(arr,0,size-1));
    printf("----");
    printf("\n- - After Sorting - -\n");
    permissionPrint(arr,size);
}
